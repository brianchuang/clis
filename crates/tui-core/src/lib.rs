...
// Re-export scoring primitives from ranking-core so downstream crates
// that already import from tui-core don't need to change.
pub use ranking_core::{compute_filtered, merge_scores, score_fuzzy, score_recency};
